  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        className={`w-full relative rounded-xl border-fun-pink border p-2 transition hover:-translate-y-2 hover:opacity-75 hover:border-fun-pink will-change-projectCard`}
      >
        <img
